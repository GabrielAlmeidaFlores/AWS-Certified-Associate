...
An AWS CloudFormation Stack is a collection of AWS resources that you can manage as a single unit. When you create a stack, CloudFormation provisions the specified resources for you, and when you delete the stack, CloudFormation deletes the resources it created.

A CloudFormation stack is defined by a CloudFormation template, which is a JSON or YAML file that specifies the resources you want to create and their configurations. The resources within a stack can include a wide range of AWS services, such as EC2 instances, S3 buckets, security groups, Lambda functions, etc.
